...
class ProtectedAuthorityService:
    ...
    def handle(self,raw_request:Mapping[str,Any],*,peer_context:PeerContext)->dict:
        ...
        try:
            ...
            if op=='verify_launch_authority':
            ...
            elif op in {'prepare_self_build','prepare_self_build_replacement','self_build_status','revoke_self_build_worker','complete_self_build_worker'}:
                ...
                try:
                    ...
                    elif op=='complete_self_build_worker':result=self.self_build_runtime.complete_worker(r['payload'])
