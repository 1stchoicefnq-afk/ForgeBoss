...
class ProtectedAuthorityService:
    ...
    def handle(self,raw_request:Mapping[str,Any],*,peer_context:PeerContext)->dict:
        ...
        try:
            ...
            elif op in {'prepare_self_build','prepare_self_build_replacement','compose_self_build_successor','activate_self_build_successor','self_build_status','revoke_self_build_worker','record_self_build_handoff','review_self_build_candidate','accept_self_build_candidate'}:
