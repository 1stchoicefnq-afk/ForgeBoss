...
OPERATIONS={'read_github_control','publish_report_comment','publish_reviewed_draft_pr','verify_launch_authority','prepare_self_build','prepare_self_build_replacement','self_build_status','revoke_self_build_worker','record_self_build_handoff','record_self_build_review','accept_self_build_candidate'}
