...
def main():
    ...
    # Unique-temp + fsync + atomic replace, stamped with the producing writer so
    # one run's evidence cannot be silently attributed to another.
    p=ss.publish_artifact(STATE/"debug-funnel-last.json",obj)
