            ...
            def do():
                ...
                env={
                  ...
                  "runtime":{
                    ...
                    "dockerPath":verified_launch.docker_identity.path if verified_launch and verified_launch.docker_identity else None,
                    "dockerSha256":verified_launch.docker_identity.sha256 if verified_launch and verified_launch.docker_identity else None,
                    "dockerSize":verified_launch.docker_identity.size if verified_launch and verified_launch.docker_identity else None,
                  },
