...
class StoreTransactionCollisionTests(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.td.cleanup()
    def task(self,task_id,paths,budget=2.0,repository="1stchoicefnq-afk/ForgeBoss"):
        return self.store.create_task({"taskId":task_id,"repository":repository,"purpose":"test","baseSha":"a"*40,"branch":"b-"+task_id,"allowedPaths":list(paths),"requiredTests":[],"budgetUsd":budget})
