...
class SchemaTests(unittest.TestCase):
    ...
    def test_branch_matches_git_component_rules(self):
        ...
        for bad in ("-topic","topic/.hidden","topic.lock/child","topic/.hidden/child","topic/child.lock/grandchild"):
    ...
    def test_scope_hostile_windows_forms(self):
        for bad in ("C:/src/a.py","/src/a.py","//server/share/a.py","src\\a.py","src/a.py.","src/a.py ","src/a.py:ads","NUL.txt","COM¹","COM².txt","LPT³.log","src//a.py","src/../a.py"):
    ...
    def test_worktree_lexical_root_bound(self):
        ...
        for bad in ("relative/work","c:/work/one","C:\\work\\one","C:/work/../one","C:/work/one.","C:/work/COM¹","C:/work/LPT².txt"):
