...
def _assert_safe_execution_config(work:Path,gitdir:Path,common:Path):
    ...
    # Compute effective ext transport policy using Git's specific-key precedence.
    # Explicit protocol.ext.allow overrides protocol.allow. Without the specific
    # key, a permissive generic fallback can make ext:: executable again.
