...
const { canonicalRepoPath }=require('./lib/scope');
let pass=0,fail=0;
...
for(const bad of ['../x','src/../x','/etc/passwd','C:/x','//server/share','src\\x','src/a.',' src/a.js'])ok(`scope path rejected: ${bad}`,()=>throws(()=>canonicalRepoPath(bad)));
