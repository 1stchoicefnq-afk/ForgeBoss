...
ok('dashboard.self_build_fail_closed',shell.includes('self_build_preflight')&&shell.includes('PREFLIGHT_BLOCKED')&&shell.includes('ProtectedAuthorityClient.from_environment')&&shell.includes('Paid workers have NOT started yet.'));
