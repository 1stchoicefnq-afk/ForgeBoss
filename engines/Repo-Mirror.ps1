...
if(-not(Test-Path -LiteralPath $MirrorPath)){$r=Run 'git.exe' @('clone','--mirror','--filter=blob:none',$RepoUrl,$MirrorPath)}else{$r=Run 'git.exe' @('remote','update','--prune') $MirrorPath}
